...
export function PantryStatus({ onClick }: PantryStatusProps) {
  return (
    <div className="px-6 cursor-pointer" onClick={onClick}>
      <div className="bg-brand-500/10 rounded-lg p-5 text-white active:scale-[0.98] transition-transform border border-brand-500/20 lg:h-full">
        ...
        <div className="flex gap-4">
          <div className="flex-1 bg-brand-400/10 rounded-md p-3 backdrop-blur-sm">
            <span className="block text-xs text-brand-100 mb-1">Fresh</span>
            <p className="text-xl font-bold">24</p>
            <p className="text-[10px] text-brand-200">Items</p>
          </div>
          <div className="flex-1 bg-brand-400/10 rounded-md p-3 backdrop-blur-sm">
            <span className="block text-xs text-yellow-200 mb-1">Expiring</span>
